...
<style>
  ...
  .daily-hero-stats span { min-height: 32px; display: inline-flex; align-items: center; padding: 0 12px; border-radius: 999px; background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.86); font-size: 12px; font-weight: 700; animation: dailyChipIn 360ms cubic-bezier(.2,.8,.2,1) both; }
  .daily-hero-stats span:nth-child(2) { animation-delay: 45ms; }
  .daily-hero-stats span:nth-child(3) { animation-delay: 90ms; }
  .daily-hero-play { flex-shrink: 0; height: 46px; padding: 0 22px; border: none; border-radius: 999px; background: var(--accent); color: white; font-weight: 700; cursor: pointer; box-shadow: 0 12px 28px color-mix(in srgb, var(--accent) 24%, transparent); transition: transform 0.18s, filter 0.18s, box-shadow 0.18s; }
  ...
  .daily-song-panel { border: 1px solid color-mix(in srgb, var(--border) 78%, transparent); border-radius: var(--radius-xl); background: color-mix(in srgb, var(--bg-layer) 82%, transparent); padding: 16px; box-shadow: 0 14px 42px rgba(0,0,0,0.12); animation: dailyPanelIn 360ms cubic-bezier(.2,.8,.2,1) both; }
  ...
  .daily-song-row { width: 100%; min-height: 62px; display: grid; grid-template-columns: 42px 48px minmax(0, 1.2fr) minmax(120px, 0.8fr) 52px; gap: 12px; align-items: center; padding: 7px 10px; border: none; border-radius: var(--radius-lg); background: transparent; color: var(--text); text-align: left; cursor: pointer; animation: dailyRowIn 320ms cubic-bezier(.2,.8,.2,1) both; animation-delay: calc(var(--row-index) * 28ms); transition: background 0.16s, transform 0.16s; }
