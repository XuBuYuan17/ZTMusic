...
const haptics = await readFile(new URL('../utils/haptics.ts', import.meta.url), 'utf8')
...
assert.ok(playerBar.includes("import { hapticTap } from '../utils/haptics.ts'"), 'mini player should trigger touch haptics outside the mobile shell')
