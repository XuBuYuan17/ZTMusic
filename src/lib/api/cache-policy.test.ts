 ...
 * Run: node src/lib/api/cache-policy.test.ts
 */

import { getApiCacheTtl } from './cache-ttl.ts'
...
const cachePolicy = await readFile(new URL('./cache-policy.ts', import.meta.url), 'utf8')
